...
@Tag(
    name = "Daily Logs",
    description = "Daily log tracking endpoints"
)
public class DailyLogController {
    ...
    @Operation(
        ...
        description = "Records a new daily log entry for a user"
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "201",
            ...
            content = @Content(
                schema = @Schema(
                    implementation = DailyLogResponse.class
                )
            )
        ),
        @ApiResponse(
    ...
    public ResponseEntity<DailyLogResponse> createDailyLog(
            ...
            @Parameter(description = "Daily log payload")
            @Valid
            @RequestBody
    ...
    @Operation(
        ...
        description = "Returns all daily logs for a user"
    )
    @ApiResponse(
        responseCode = "200",
    ...
    @Operation(
        ...
        description = "Fetches a specific daily log entry"
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<DailyLogResponse> getDailyLogById(
            ...
            @Parameter(
                description = "Daily log identifier"
            )
    ...
    @Operation(
        ...
        description = "Updates an existing daily log entry"
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<DailyLogResponse> updateDailyLog(
            ...
            @Parameter(
                description = "Updated daily log payload"
            )
            @Valid
            @RequestBody
            DailyLogRequest request) {
    ...
    @Operation(
        ...
        description = "Deletes a daily log entry"
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        summary = "Get daily logs by date",
        description = "Returns daily logs for a specific date"
    )
    @ApiResponse(
        responseCode = "200",
    ...
    @Operation(
        ...
        description = "Returns the weekly logged hours total"
    )
    @ApiResponse(
        responseCode = "200",
